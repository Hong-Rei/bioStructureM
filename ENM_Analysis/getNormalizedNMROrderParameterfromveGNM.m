function [order_parameter] = getNormalizedNMROrderParameterfromveGNM(PDB_Structure,eigvalues,mode_selection)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This function calculates the veGNM theroretical predicted NMR NOE order parameter profile of a specified bond vector.
...
% 
% input:
%   eigvalues are veGNM eigenvalues
%   PDB_Structure are Structure obtained from veGNM.m with veGNM fields.
...
%   
% return:
%   order_parameter: order parameter(S^2) profile calculated theoretically from veGNM for each residue.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    eigvectors = getveGNM(PDB_Structure,mode_selection);
