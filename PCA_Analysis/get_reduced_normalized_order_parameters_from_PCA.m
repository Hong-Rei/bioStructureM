function [reduced_order_parameter_from_PCA] = get_reduced_normalized_order_parameters_from_PCA(eigvalues,eigvectors,mean_struct)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for i = 1:num_of_modes
        ...
        reduced_order_parameter_from_PCA(:,i) = getNormalizedNMROrderParameterfromPCA(eigvalues,eigvectors,mean_struct,mode_selection);
    end
