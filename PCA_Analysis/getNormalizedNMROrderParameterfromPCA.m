function [order_parameter] = getNormalizedNMROrderParameterfromPCA(eigvalues,eigvectors,mean_struct,mode_selection)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This function calculates the PCA theroretical predicted NMR NOE order parameter profile of a specified bond vector.
