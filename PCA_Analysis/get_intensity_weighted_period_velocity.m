function [intensity_weighted_period] = get_intensity_weighted_period_velocity(power_spectrum,time_interval)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%	Calculate the intensity weighted period of a trajectory using the velocity power spectrum.
%   See: Velocity Power Spectrum.pdf
% 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	intensity_weighted_period = sum(current_intensity.*(effective_period).^3)/sum(current_intensity.*(effective_period).^2);
end
